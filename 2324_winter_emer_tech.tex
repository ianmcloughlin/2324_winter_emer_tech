...
\section{Purpose}
The purpose of this assessment is to ensure students can demonstrate they can do the following.
\begin{enumerate}
...
\end{enumerate}
The assessment is used to determine a mark out of 100\% based on the details in this document.


\section{Instructions}

\begin{itemize}
  \item There are three components in this assessment.
  \begin{itemize}
  ...
  \item You should start immediately, spreading the work throughout the semester. This will ensure you make regular commits to your repository.
  ...
  \item Towards the end of the semester you may be asked to demonstrate the work to date in your repository during your usual lab time\footnote{You will be notified in lectures as to when this will happen and attendance is mandatory.}.
\end{itemize}
...
\begin{itemize}
  \item Each topic covered in lectures will have a task associated with it.
...
\begin{itemize}
  ...
  \item Explain the problem in your notebook.
  \item Explain Deutsch's algorithm to solve the problem using a combination of MarkDown, Latex notation, tables, and plots as appropriate.
  \item Build a quantum circuit using Qiskit~\autocite{qiskit} to implement the algorithm, including any required oracle circuits to demonstrate the algorithm.
...
\begin{itemize}
  ...
  \item If you have any doubts about what is allowed, email me\footnote{\url{ian.mcloughlin@atu.ie}}.
\end{itemize}
